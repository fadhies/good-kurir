...
export default function Home() {
  ...
  return (
    <Layout>
      {/* Hero */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-[#FA00C2] to-pink-700 p-5 md:p-8 text-white shadow-xl shadow-primary/20">
