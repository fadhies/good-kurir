...
const TABLES = {
  ...
  WithdrawalRequest: { table: "withdrawal_requests", cols: ["id","created_date","updated_date","created_by_id","user_id","amount","bank_name","account_number","account_holder_name","status","transfer_proof_photo","processed_by_id","rejection_reason"] },
